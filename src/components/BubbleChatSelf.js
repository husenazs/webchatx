        ...
        <div className="flex items-start gap-2.5 my-8 px-4 flex-row-reverse">
            ...
            <div className="flex flex-col gap-1 w-auto max-w-[320px]">
                <div className="flex flex-col leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                    <p className="text-sm font-normal text-gray-900 dark:text-white"> Cool. I'll let you know when it's done.</p>
                </div>
                <span className="text-xs font-normal text-gray-500 dark:text-gray-400 text-right">17:47</span>
            </div>
